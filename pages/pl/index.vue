<template>
  <div class="container mx-auto py-16">
    <h1 class="font-heading uppercase mb-8">Polish Movies</h1>
...
export default {
  ...
  asyncData ({ params, error }) {
    ...
    return axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=fa60ca0bb69cf9b8b1e987abf0e50d97&language=pl-PL&sort_by=release_date.desc&release_date.lte=${formatted_date}&with_original_language=pl&include_adult=false&include_video=false&page=1`)
    .then((res) => {
